...
<main>
                ...
                <td>
                    <div data-overflow-menu>
                        <button type="button" aria-haspopup="menu"
                            aria-controls="contact-menu-{{ getId }}"
                            >Options</button>
                        <div role="menu" hidden id="contact-menu-{{ getId }}">
                            <a role="menuitem" href="/contacts/{{ getId }}/edit">Edit</a>
                            <a role="menuitem" href="/contacts/{{ getId }}">View</a>
                            <a role="menuitem" href="#"
                                hx-delete="/contacts/{{ getId }}"
                                hx-select="#contacts"
    ...
    <p >
        ...
        <span hx-get="/contacts/count" hx-trigger="revealed, recountEvent from:body">
          <img id="spinner" style="height: 20px"  class="htmx-indicator" src="/spinning-circles.svg"/>
        </span>
        ) total Contacts.    </p>
