    ...
    <fieldset>
        ...
        <div class="table rows">
            <p>
                ...
                <input name="email" id="email" type="text" placeholder="Email" value="{{ contact.getEmail }}">
                <span class="error">{{ errors.email }}</span>
            </p>
            <p>
                <label for="first_name">First Name</label>
                <input name="first_name" id="first_name" type="text" placeholder="First Name" value="{{ contact.getFirst }}">
                <span class="error">{{ errors.first }}</span>
            </p>
            <p>
                <label for="last_name">Last Name</label>
                <input name="last_name" id="last_name" type="text" placeholder="Last Name" value="{{ contact.getLast  }}">
